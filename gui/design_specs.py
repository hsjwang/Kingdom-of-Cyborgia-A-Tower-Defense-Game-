...
for key, defense in defenses_dict.items():
    ...
    page_data = {
        ...
        # Real control name + MITRE identifiers, shown under the story name so
        # students meet the professional vocabulary alongside the fantasy one.
        "mitre": defense.framework_line,
